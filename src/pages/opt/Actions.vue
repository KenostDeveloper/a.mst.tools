<template>
    <div>
        ...
        <div class="dart-row">
            <router-link :to="{ name: 'promotion', params: { id: this.$route.params.id, action: item.action_id } }" v-for="item in action_buyer.items" v-bind:key="item.id" class="d-col-xxl-3 d-col-xl-4 d-col-lg-6 d-col-12 link-no-style mb-3">
