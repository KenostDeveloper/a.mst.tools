<template>
	...
	<div class="copo">
		...
		<p class="info-text mb-4">
			Для работы вам необходимо достигнуть и поддерживать уровень сопоставления товаров по
			стоимости не менее 80%.
		</p>
						...
						<div class="panel-widget panel-widget-remains">
							...
							<div class="panel-widget-remains__stat">
								...
								<div class="panel-widget-remains__stat-item">
									...
									<div class="line">
										<span
											:style="'width: ' + prods.copo_money_percent + '%;'"
										></span>
									</div>
								</div>
							</div>
							<div class="products_href">
								<router-link
									:to="{ name: 'report_copo', params: { id: $route.params.id } }"
								>
					...
					<div class="d-col-xxl-3 d-col-lg-6" v-if="products.status">
						<div class="dart-helper dart-helper-4">
							...
							<div class="dart-helper-footer" v-bind:class="{ show: helpers[0][3] }">
								<div class="dart-helper-footer__text">
									<p>
										Проверьте правильность вашего артикула в нашем каталоге
										карточек
									</p>
			...
			<div class="add-brand__content" @click.stop="">
				...
				<form class="add-brand__body">
					<p class="info-text mb-3">
						Прежде чем оставлять запрос, проверьте, не оставлял ли кто-то такой запрос
						до вас.
					</p>
					<div class="dart-row">
					...
					<div class="flex flex-wrap g-3 mt-2">
						<div class="flex align-items-center">
							<RadioButton
								v-model="this.addBrandForm.canCall"
								inputId="ingredient1"
	...
	<div class="add-brand" v-bind:class="{ active: isModalBrand }" @click="modalToggleBrand">
		<div class="add-brand__content" @click.stop="">
			...
			<form class="add-brand__body">
				<p class="info-text mb-3">
					Прежде чем оставлять запрос, проверьте, не оставлял ли кто-то такой запрос до
					вас.
				</p>
				<div class="dart-row">
					<div class="d-col-md-6">
