<template>
    <div :class="`navmain std-nav ${catalogIsOpened ? 'std-nav--active' : ''}`">
        ...
        <div :class="`std-catalog ${catalogIsOpened ? 'std-catalog--active' : ''} hidden-desktop-s-minus`">
            ...
            <div class="std-catalog__primary-tabs-container">
                <div class="std-catalog__tabs">
                    ...
                    <button
                        :class="`std-catalog__tab-item std-tab-item ${this.organizationsOrCategories === 'categories' ? 'std-tab-item--active' : ''}`"
        ...
        <div :class="`std-catalog ${catalogIsOpened ? 'std-catalog--active' : ''} visible-desktop-s-minus`">
            ...
            <div class="std-catalog__tabs">
                <button
                    :class="`std-catalog__tab-item std-tab-item ${this.organizationsOrCategories === 'organizations' ? 'std-tab-item--active' : ''}`"
                    @click="setOrganizationsOrCategories('organizations')">
                    <div class="std-tab-item__img-container">
                        <img src="../../assets/images/icons/org-catalog.svg" alt="" />
                    </div>
                    ...
                    <li v-for="suggestion in searchSuggestions" class="std-search-field__suggestion" @click="() => {
                        ...
                        <div class="std-product-card-s">
                            ...
                            <div class="std-product-card-s__content">
                                ...
                                <span class="std-product-card-s__article">арт. {{ suggestion.article }}</span>
                            </div>
                        </div>
                    </li>
                </ul>
